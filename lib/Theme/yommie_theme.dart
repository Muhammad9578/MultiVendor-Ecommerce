...
class YommieTheme {
  ...
  static ThemeData buildLightTheme() {
    final Color primaryColor = HexColor('#d9ecf2');
    final Color secondaryColor = HexColor('#d9ecf2');
  ...
  static const TextStyle appBarPts = TextStyle(
      fontFamily: fontName,
  ...
  static const kMosBlackBoldSmall = TextStyle(
    fontSize: 12,
    fontWeight: FontWeight.bold,
