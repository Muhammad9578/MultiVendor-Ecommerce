...
class ListCancelled extends StatefulWidget {
  @override
  _ListCancelledState createState() => _ListCancelledState();
}

class _ListCancelledState extends State<ListCancelled> {
  bool loading = true;
  List<PurchasesData> listCancelled = [];

  @override
  void initState() {
    var jsons = {};
    jsons['type'] = 'cancelled';
        ...
        : listCancelled.isEmpty
            ...
            : ListView(
                children: [
                  ...
                  Column(
                    children: listCancelled.map((PurchasesData item) {
                      textShippingStatus() {
