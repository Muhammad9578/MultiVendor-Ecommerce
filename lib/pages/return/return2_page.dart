...
//* this page from list to receive page
class ReturnPage2 extends StatefulWidget {
  final ListItem childItem;
  ReturnPage2({this.childItem});
  @override
  _ReturnPage2State createState() => _ReturnPage2State();
}

class _ReturnPage2State extends State<ReturnPage2> {
  ListItem childItem;
  int _groupValue = -1;
