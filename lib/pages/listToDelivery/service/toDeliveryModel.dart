...
class PurchasesCategory {
  static Future<List<PurchasesData>> purchasesCategoryPhp(jsons) async {
    try {
      var result = await GetAPI.providers(jsons, 'purchases-category.php');
