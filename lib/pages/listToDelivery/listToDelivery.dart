...
class ListToDelivery extends StatefulWidget {
  @override
  _ListToDeliveryState createState() => _ListToDeliveryState();
}

class _ListToDeliveryState extends State<ListToDelivery> {
  bool loading = true;
                                ...
                                switch (item.shippingStatus) {
                                  case ShippingStatus.CANCELLED:
                                    return Row(
                                      ...
                                      children: [
                                        button('BUY AGAIN', () {},
                                            Color.fromRGBO(234, 135, 137, 1.0)),
                                        SizedBox(width: 5),
                                        button('SEE DETAILS', () {},
                                            Color.fromRGBO(234, 135, 137, 1.0)),
                                        SizedBox(width: 10),
  ...
  ButtonTheme button(String title, Function onTap, Color colour) {
    return ButtonTheme(
      minWidth: 80.0,
      height: 40.0,
      buttonColor: colour,
