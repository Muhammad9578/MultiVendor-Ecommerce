...
import 'package:mos_beauty/pages/Rate/rate_page.dart';
...
class _ListCompletedState extends State<ListCompleted> {
  ...
  _goToPageRate(ListItem childItem) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (BuildContext context) => RatePage(
          childItem: childItem,
        ),
      ),
    ).then((value) => _callInitApi());
  }
